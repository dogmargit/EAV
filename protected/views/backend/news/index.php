                ...
                array( 
                    ...
                    'buttons' => array(
                        'btnDefault' => array(
                            ...
                            'url'   => 'array("news/view", "id" => $data -> id, "name" => $data -> url)',
                            'imageUrl'  => false,
                            'options' => array('onclick'=>'window.open($(this).attr("href")); return false;', 'title'=>'Открыть'),
                        ),
                        'btnEdit' => array(
                            'label' => '<span class="icon-pencil tip" data-original-title="Изменить"></span>',
                            'url' => 'array("/admin/news/update/$data->id")',
                            'imageIcon' => false,
                            'options' => array('class'=>'', 'title'=>''),
                        ),
                        'delete' => array(
                            'label' => '<span class="icon-remove tip" data-original-title="Удалить"></span>',
                            'url' => 'array("/admin/news/delete/$data->id")',
                            'imageUrl' => false,
                            'options' => array('title'=>''),
                        ),
                    ),
