    ...
    <div class="span12">                
        <div class="widget">
            ...
            <div class="block-fluid">
                ...
                <div class="row-form">
                    <div class="span2"><?php echo $form->labelEx($model,'text'); ?></div>
                ...
                <div class="row-form" style="padding:10px 10px">
                    <div class="span2">Изображение:</div>
                    <div class="span10">    
                        <?php if($model->pic):?>
                        <div class="row-form">
...
<div class="widget">
    <div class="row-fluid">
        <div class="toolbar bottom TAL">
            ...
            <a class="btn" href="/admin/news/">Вернуться</a>    
        </div>                      
    </div>  
</div>
<?php $this->endWidget(); ?>