...
class EShoppingCart extends CMap {
     ...
     */
    public function put(IECartPosition $position, $quantity = 1, $options = '') {
        $key = $this->setKey($position->getId(), $options);
        ...
        $this->update($position, $quantity, $options);
     ...
     * @param int $quantity
     */
    public function update(IECartPosition $position, $quantity, $options = false) {
    ...
    public function setKey($id, $options)
    {
        return $id.'_'.$options;
    }
